...
# name=data.get_semantic_label(2)
# print(name)

# X=data.get_examples_by_label('train', 2, num_examples=1)
# y=np.ones(len(X))*2

# train_set= MyDataset(X, y)
# train_loader = DataLoader(train_set, batch_size=1, shuffle=True)
# t=next(iter(train_loader))[0].numpy()
# print(t.shape[0],t.shape[1])

# image = plt.imread('/home/ashlee/cs348/cs349/spring2021-hw6-deep-learning-ashleetiw/data/DogSet/images/000183.png')
# plt.imshow(image)
# plt.show()

# import torchvision.transforms as transforms
# for i in t:
#     imshow(transforms.ToPILImage()(transforms.ToTensor()(t)), interpolation="bicubic")
